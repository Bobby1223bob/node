...
public abstract class ShufflingTransaction extends TransactionType {
    ...
    private final static Fee SHUFFLING_PROCESSING_FEE = new Fee.ConstantFee(Constants.ONE_NXT/100);
    private final static Fee SHUFFLING_RECIPIENTS_FEE = new Fee.ConstantFee(Constants.ONE_NXT/100);
