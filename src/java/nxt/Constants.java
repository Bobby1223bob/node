...
public final class Constants {
    ...
    public static final String COIN_SYMBOL = "BLX";
    public static final String ACCOUNT_PREFIX = "BLX";
    public static final String PROJECT_NAME = "Blue0x";
    ...
    public static final int BLOCK_TIME = 4;
    public static final long INITIAL_BASE_TARGET = BigInteger.valueOf(2).pow(63).divide(BigInteger.valueOf(BLOCK_TIME * MAX_BALANCE_NXT)).longValue();
    ...
    public static final int MAX_BLOCKTIME_LIMIT = BLOCK_TIME;
    ...
    public static final int MAX_TIMEDRIFT = 5; // allow up to 5s clock difference
