...
public class APITestServlet extends HttpServlet {
    ...
    private static final String header1 =
            ...
            "           <a class='navbar-brand' href='/test'>Blue0x API</a>\n" +
            "       </div>\n" +
            "       <div class='navbar-collapse collapse'>\n" +
            "           <ul class='nav navbar-nav navbar-right'>\n" +
            "               <li><input type='text' class='form-control' id='search' " +
            "                    placeholder='Search' style='margin-top:8px;'></li>\n" +
            "               <li><a href='https://blue0x.com/docs/api' target='_blank' style='margin-left:20px;'>API Docs</a></li>\n" +
            "           </ul>\n" +
            "       </div>\n" +
            "   </div>\n" +
            "</div>\n" +
